...
ALLOWED_HOSTS = ["*", "https://alex-boutique-ado.herokuapp.com/"]
...
LOGIN_REDIRECT_URL = '/'  # redirect back after login in
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'alex-boutique-ado'
...
if 'DEVELOPMENT' in os.environ:
    DEFAULT_FROM_EMAIL = 'info@gradko.ru'
